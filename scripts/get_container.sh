...
curl -u"administrator:test" -H "x-cdmi-specification-version: 1.1"  -H "Accept: application/cdmi-container" -X GET "http://localhost:4000/api/v1/new_container1/" -v |python -m json.tool

...
curl -u"mmartin:test;realm=default_domain" -H "x-cdmi-specification-version: 1.1" -H "Accept: application/cdmi-object" -X GET "http://localhost:4000/cdmi/v1/new_container3/new_object1.txt" -v > /tmp/janice # |python -m json.tool
